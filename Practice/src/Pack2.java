...
public class Pack2 {
    ...
    public static int encode(char c1, char c2, char c3, char c4, char c5) {
        ...
        int place0 = (int) (value1 * Math.pow(BASE56, 4));
        int place1 = (int) (value2 * Math.pow(BASE56, 3));
     ...
     */
    public static void decode(int num, DecodedValue decodedResult) {
        ...
        decodedResult.c1 = char1;
        decodedResult.c2 = char2;
        decodedResult.c3 = char3;
        decodedResult.c4 = char4;
        decodedResult.c5 = char5;
    }
    ...
    public static void main(String[] args) {  
        ...
        DecodedValue decodedResult = new DecodedValue();
        decode(num, decodedResult);    
        System.out.println("Decoded: " + decodedResult.c1 + decodedResult.c2
            + decodedResult.c3 + decodedResult.c4 + decodedResult.c5);
    }
}
